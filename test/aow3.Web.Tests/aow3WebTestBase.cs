...
{
    public abstract class aow3WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static aow3WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(aow3WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<aow3DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<aow3DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<aow3DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<aow3DbContext, Task<T>> func)
        {
            T result;
