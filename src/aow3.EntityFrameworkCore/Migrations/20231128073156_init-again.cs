        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdPost = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdAttachments = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TTPD = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaiDangForum", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Thang = table.Column<int>(type: "int", nullable: false),
                    Nam = table.Column<int>(type: "int", nullable: false),
                    isSticker = table.Column<bool>(type: "bit", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TaiKhoanGoogle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MatKhau = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Ma10So = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SoTienCayGold = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DangKyCayGolds", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "PhanThuongVongQuay",
                schema: "spin",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                    ...
                    ThoiGianQuay = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Ngay = table.Column<int>(type: "int", nullable: false),
                    Thang = table.Column<int>(type: "int", nullable: false),
                    Nam = table.Column<int>(type: "int", nullable: false),
                    PhanThuong = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhanThuongVongQuay", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    permalink_url = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    idAttachment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostFaceBooks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewPostFanpageFaceBook", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ViewVongQuayMayMans",
                schema: "dbo",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    UserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ThoiGianCapNhatSpin = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ThoiGianTaoSpin = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ThoiGianQuay = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    PhanThuong = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TongSoLuotQuay = table.Column<int>(type: "int", nullable: false),
                    SoLuotDaQuay = table.Column<int>(type: "int", nullable: false),
                    SoLuotConLai = table.Column<int>(type: "int", nullable: false),
                    TTPD = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TTCK = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewVongQuayMayMans", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "VongQuayMayMans",
                schema: "spin",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VongQuayMayMans", x => x.Id);
                });
